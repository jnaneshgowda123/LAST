...
DATABASE_NAME = environ.get('DATABASE_NAME', "techvjclonefilterbot") # Database name (default: cluster)
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'vjcollection') # Collection name (default: dreamcinezone_files)
